(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hey")) new swiper_core_Swiper("[data-hey] .swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loop: true,
            navigation: {
                prevEl: "[data-hey] .swiper-button-prev",
                nextEl: "[data-hey] .swiper-button-next"
            },
            breakpoints: {
                992: {
                    autoHeight: false
        ...
        if (document.querySelector(".work")) new swiper_core_Swiper("[data-work] .swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loop: false,
            navigation: {
                prevEl: "[data-work] .swiper-button-prev",
                nextEl: "[data-work] .swiper-button-next"
            },
            breakpoints: {
                768: {
                    slidesPerView: "auto"
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        var phone = document.querySelector(".phone"), phone_open = document.querySelector(".phone__icon"), phone_close = document.querySelector(".phone button");
        phone_open.addEventListener("click", (() => {
            phone.classList.add("show");
        }));
        phone_close.addEventListener("click", (() => {
            phone.classList.remove("show");
        }));
        var lang = document.querySelector(".lang"), lang_open = document.querySelector(".lang p"), lang_close = document.querySelector(".lang button");
        ...
        var menu = document.querySelector(".header__menu"), menu_open = document.querySelector(".header__menu button"), menu_close = document.querySelector(".header__menu .header__modal button");
